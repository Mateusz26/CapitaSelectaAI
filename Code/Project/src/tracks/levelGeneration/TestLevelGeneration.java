...
public class TestLevelGeneration {
    ...
    public static void main(String[] args) {
		...
		String geneticGeneratorTournamentSelection = "tracks.levelGeneration.geneticLevelGenerator.Improved.LevelGenerator";
		...
		if(LevelGenMachine.generateOneLevel(game, geneticGeneratorTournamentSelection, recordLevelFile)){
